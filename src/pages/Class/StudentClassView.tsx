...
import { Hash, LogIn, LogOut, Users, X } from 'lucide-react'
import { getGeneralclass } from '../../store/slices/classSlice'
import { useDispatch, useSelector } from 'react-redux'
import { RootState } from '../../store'
import { AppDispatch } from '../../store'
import { useNavigate } from 'react-router-dom'
import { joinClassThunk } from '../../store/slices/classSlice'
...
export const StudentClassView = () => {
  ...
  const handleSubmit = (values: { code: string; pass?: string }) => {
    dispatch(joinClassThunk(values))
    setDialogOpen(false)
  }
  return (
